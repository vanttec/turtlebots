...
echo_and_run cd "/home/ivan5d/turtlebots/src/turtlebots_sim/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ivan5d/turtlebots/src/turtlebots_sim/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/ivan5d/turtlebots/build/turtlebots_sim/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
